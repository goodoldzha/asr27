...
<tr>
	<th><label for="display_name" style="visibility: hidden;"><?php _e('Display name publicly as') ?></label></th>
	<td>
		<select name="display_name" style="visibility: hidden;" id="display_name">
		<?php
