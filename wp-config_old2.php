...
define( 'WPCACHEHOME', '/homepages/28/d474812264/htdocs/wp-content/plugins/wp-super-cache/' ); //Added by WP-Cache Manager
define('DB_NAME', 'db475788880');

/** MySQL database username */
define('DB_USER', 'dbo475788880');

/** MySQL database password */
define('DB_PASSWORD', '10ps27roma$');

/** MySQL hostname */
define('DB_HOST', 'db475788880.db.1and1.com');
