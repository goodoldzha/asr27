...
//CONFIG////////>
  ...
  var WpQtButtonsArray = new Array(
     new WpQtButton("<b>B</b>", "insertHtmlTags(document.getElementById('comment'), 'strong', '', '', '')", "Bold"),
     new WpQtButton("<em>i</em>", "insertHtmlTags(document.getElementById('comment'), 'em', '', '', '')", "Italic"),
     new WpQtButton("<u>U</u>", "insertHtmlTags(document.getElementById('comment'), 'u', '', '', '')", "Underline"),
     new WpQtButton("<del>del</del>", "insertHtmlTags(document.getElementById('comment'), 'del', '', '', '')", "Line"),
     new WpQtButton("<img src=\""+CommentFormToolbar_imagesPath+"url.gif\" />", "insertHtmlTags(document.getElementById('comment'), 'a', {href: 'http://', target: '_blank'}, {href: 'Введите URL:'}, '', '')", "Hyperlink"),
     new WpQtButton("<img src=\""+CommentFormToolbar_imagesPath+"img.gif\" />", "insertHtmlTags(document.getElementById('comment'), 'img', {src: 'http://'}, {src: 'Введите адрес изображения:'}, '', '')", "Insert Image")
  );
//CONFIG////////<
