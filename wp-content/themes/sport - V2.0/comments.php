...
<div style="width: 75%; border-style: solid; background-color:#EE992F; padding: 10px 20px 20px 20px; margin: 10px auto 10px auto;">

<p style="text-align:center;">رمی عزیز، برای مشاهده نظرات و نظردهی بایستی به سایت <a href="http://asroma27.com/v16/wp-login.php">وارد</a> شوید.</p>
            ...
            <div class="comment-main">
				<div class="comment-bg">
					<div class="comment-info">
						<div class="avatars"><?php if(function_exists('get_avatar')) { echo get_avatar($comment, '85'); } ?></div>
 ...
 */ ?>
    ...
    <?php $fck_user_ID = get_userdata( get_current_user_id() )->ID; ?>

    <?php if (get_option('comment_registration') && !$fck_user_ID ) : ?>
        <p id="comments-blocked"><?php _e('No Comments Yet','postechin'); ?><?php _e('You must be','postechin'); ?> <a href="<?php echo get_option('siteurl'); ?>/v16/wp-login.php?redirect_to=
    ...
    <p>Logged in as <a href="<?php echo get_option('siteurl'); ?>/wp-admin/profile.php">
        ...
        <a href="<?php echo get_option('siteurl'); ?>/v16/wp-login.php?action=logout" title="Log out of this account"><?php _e('Logout','postechin'); ?></a>
    </p>
