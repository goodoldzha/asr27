...
<script type="text/javascript">
	...
	if ($('.home-logo').length == 4) {
        $(".ujic-hold").prependTo($("div.last-match-middle")[0]);
		$(".ujic-hold").css("direction", "ltr");
        $("div.last-match-middle").first().css("height", "115px");
        $("div.last-match-middle").first().css("padding-top", "5px");
        $("div.last-match-middle").first().css("font-family", "BBCNassim !important");

    }

    else {
        $("div.match").first().css("display", "none");
		$(".ujic-hold").css("visibility", "hidden");
        $("div.last-match-middle").first().css("height", "115px");
...
<?php wp_footer(); ?>
	...
	$( document ).ready(function() {
	    	...
	    	$(".copyright").html('<div style="height: 24px; background-color: black;"><p style="padding-top:0; float:right;">کلیه حقوق محفوظ است. استفاده از مطالب با ذکر منبع بلامانع است.</p><p style="padding-top:0; float:left;"><span style="color:white;">طراحی: </span><a href="http://www.peyman.me" style="color:yellow;">پیمان اسکندری</a></p></div>');
...
<script type="text/javascript">
	...
	$(".wp_rp_wrap").before('<a href="http://asroma27.com/?p=66686" target="_blank"><img class="post-image-center" src="http://asroma27.com/v16/wp-content/uploads/2015/06/as-roma-banner-sponser.jpg" alt="asroma_banner" width="468" ></a>');
...
<script type="text/javascript">
	...
	$("div.single-thumb > .attachment-single-thumbnail.wp-post-image").after('<a href="http://www.aparat.com/Romachannel" target="_blank"><img style="width: 360px; margin-bottom: 15px;" class="post-image-center" src="http://asroma27.com/v16/wp-content/uploads/2015/06/aparat-logo.jpg" alt="RomaChannel"></a>');
...
<script>
	$("label.screen-reader-text").css("display", "none");
</script>
