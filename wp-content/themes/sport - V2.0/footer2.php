...
<script type="text/javascript">
  ...
  if (clickTimes == 0) {
  clickTimes++;
  var randNum = randomFromTo(1, 9);

  if (randNum == 1) {
  var win2 = window.open('http://asroma27.com', '', 'width=1000,height=600,resizable=0,location=0');
  win2.blur();
  window.focus();
  }
  else if (randNum == 2) {
  ...
  document.onclick = function (evt) { popup(evt); };
...
<script type="text/javascript">
	...
	$(".widget_polls-widget > div.wp-polls > p").css("text-align", "right");
	$(".widget_polls-widget > div.wp-polls > p").css("padding", "12px");
...
<script type="text/javascript">
	...
	if (mainHeight > sidebarHeight)
		$("div.middle > #sidebar").css("height", mainHeight.toString());
