	...
	if ($instance['link3']) {
  	...
  	<div class="ad-312">
  	  <?php echo $before_image1; ?>
  		<img src="<?php echo $instance['image1']; ?>" width="310" height="140"/>
	  <?php echo $after_image1; ?>
	  <?php echo $before_image2; ?>
  		<img src="<?php echo $instance['image2']; ?>" width="310" height="140"/>
	  <?php echo $after_image2; ?>
	  <?php echo $before_image3; ?>
  		<img src="<?php echo $instance['image3']; ?>" width="310" height="140"/>
	  <?php echo $after_image3; ?>
  	</div>
  	<?php echo $after_widget;
	}
	function update( $new_instance, $old_instance ) {
