...
$('#italia-news-button').click(function(e){
    ...
    $('div.headlines.active').fadeOut('fast', function(){
        ...
        $('div.news-tabs > div.tab-button-container > a.active-button').removeClass('active-button');
        $('div.news-tabs > div.tab-button-container > a#italia-news-button').addClass('active-button');
        $('div.headlines.active').fadeIn('fast');
    });
...
$('#europe-news-button').click(function(e){
    ...
    $('div.headlines.active').fadeOut('fast', function(){
        ...
        $('div.news-tabs > div.tab-button-container > a.active-button').removeClass('active-button');
        $('div.news-tabs > div.tab-button-container > a#europe-news-button').addClass('active-button');
        $('div.headlines.active').fadeIn('fast');
    });
...
$('#world-news-button').click(function(e){
    ...
    $('div.headlines.active').fadeOut('fast', function(){
        ...
        $('div.news-tabs > div.tab-button-container > a.active-button').removeClass('active-button');
        $('div.news-tabs > div.tab-button-container > a#world-news-button').addClass('active-button');
        $('div.headlines.active').fadeIn('fast');
    });
});
