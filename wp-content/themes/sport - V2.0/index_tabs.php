	...
	<div class="tab-button-container"><a href="#" id="tiffosi-news-button" class="tab-button">تیفوسی‌ها</a></div>
			...
			$args = array(
				...
				'tax_query' => array(
					array(
						'taxonomy' => 'post_cat',
						'field'    => 'id',
						'terms'    => array( 310, 292, 286, 296, 297, 55 ),
						'operator' => 'NOT IN',
					),
				),
			);
			...
			if( $my_query->have_posts() ) {
				...
				while ($my_query->have_posts()) : $my_query->the_post(); 
					...
					if (has_term(310, 'post_cat') || has_term(292, 'post_cat') || has_term(286, 'post_cat') || has_term(296, 'post_cat') || has_term(297, 'post_cat') || has_term(55, 'post_cat')) continue; ?>
