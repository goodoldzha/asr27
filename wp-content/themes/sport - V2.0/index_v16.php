...
<!--	<div class="top-home-ad">

  <a href="http://www.wakilmodafe.com/" target="_blank"><img src="http://asroma27.com/media/images/banners/top-azar8th.gif" style=" border-style: solid; border-color: #570000; border-width: 8px 5px; margin: 0; "></a>
...
switch ($num)
{
	 case 1: echo '<script type="text/javascript" src="http://popupads.ir/popupcode?userid=2016&ptn=mix"></script>'; break;
	 case 2: echo '<script type="text/javascript" src="http://pl150885.puhtml.com/a0/da/a4/a0daa4eec997688b52aca18c66f4ce92.js"></script>';
...
<div class="news-tabs" style="width: 100%;">
	...
	<v class="tab-button-container"><a href="#" id="roma-news-button" class="tab-button active-button">رم</a></div>
...
">
	...
	;!( function( w, d ) {
	'use strict';
	var ad = { user: "1453742295", width: 600, height: 300, id: 'anetwork-' + ~~( Math.random() * 999999  ) },
...
<a href="http://ghabdooni.com/?tracking=5672dfd6371a8"><img src="http://ghabdooni.com/image/banner/486-banner.jpg" alt="486 Banner" style="width: 560px;"></a>


</div>
-->

<div style="position:fixed; right:2px; top:2px; z-index:1000; border:1px solid #D6D6D6; padding:1px; width:120px;" id="apanet_ads_top_right_120"><div style="width:114px; padding:3px; margin:0; float:right; background:#e8e8e8; color:#C40000; cursor:pointer; font-size: 8pt; font-family: tahoma; text-align: right; direction:rtl; text-decoration:none;" onclick="document.getElementById('apanet_ads_top_right_120').style.display='none'"><span style="width:7px; height:12px; margin:0 0 2px 5px; font-size: 7pt; float:right; font-weight:bold; padding: 1px 3px; background:#C40000; color:#fff;-webkit-border-radius: 3px;-moz-border-radius: 3px;border-radius: 3px;">X</span> بستن تبليغات</div><div style="float:right;width:120px;"><script type="text/javascript"  src="http://apanet.net/index.php/javascript/site/5325?img=120_240"></script></div></div>
	
<style>

#apanet_ads_top_right_120 {
    position: fixed;
    right: 10px;
    top: 46px !important;
    ...
    width: 120px;
    border-radius: 4px;
    box-shadow: -2px 2px 2px #570000;
	background-color: black;
}
</style>

<div style="position:fixed; left:2px; top:2px; z-index:1000; border:1px solid #D6D6D6; padding:1px; width:120px;" id="apanet_ads_top_left_120"><div style="width:114px; padding:3px; margin:0; float:right; background:#e8e8e8; color:#C40000; cursor:pointer; font-size: 8pt; font-family: tahoma; text-align: right; direction:rtl; text-decoration:none;" onclick="document.getElementById('apanet_ads_top_left_120').style.display='none'"><span style="width:7px; height:12px; margin:0 0 2px 5px; font-size: 7pt; float:right; font-weight:bold; padding: 1px 3px; background:#C40000; color:#fff;-webkit-border-radius: 3px;-moz-border-radius: 3px;border-radius: 3px;">X</span> بستن تبليغات</div><div style="float:right;width:120px;"><script type="text/javascript"  src="http://apanet.net/index.php/javascript/site/5325?img=120_240"></script></div></div>

<style>

#apanet_ads_top_left_120 {
    position: fixed;
    left: 10px;
    top: 46px !important;
    z-index: -1000 !important;
...
<div style="position:fixed; left:2px; bottom:2px; z-index:1000; border:1px solid #D6D6D6; padding:1px; width:120px;" id="apanet_ads_bottom_left_120"><div style="width:114px; padding:3px; margin:0; float:right; background:#e8e8e8; color:#C40000; cursor:pointer; font-size: 8pt; font-family: tahoma; text-align: right; direction:rtl; text-decoration:none;" onclick="document.getElementById('apanet_ads_bottom_left_120').style.display='none'"><span style="width:7px; height:12px; margin:0 0 2px 5px; font-size: 7pt; float:right; font-weight:bold; padding: 1px 3px; background:#C40000; color:#fff;-webkit-border-radius: 3px;-moz-border-radius: 3px;border-radius: 3px;">X</span> بستن تبليغات</div><div style="float:right;width:120px;"><script type="text/javascript"  src="http://apanet.net/index.php/javascript/site/5325?img=120_240"></script></div></div>

<style>

#apanet_ads_bottom_left_120 {
    position: fixed;
    left: 10px;
...
">
	<script type="text/javascript">
		...
		clickyab_ad['id'] = 4451431678369;
		clickyab_ad['domain'] = 'asroma27.com';
		clickyab_ad['slot'] = 52630451472;
...
<script type="text/javascript" src='http://post-sabet.ir/show.php?user=280&posttimes=4'></script>
