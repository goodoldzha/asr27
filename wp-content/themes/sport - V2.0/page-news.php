...
?>
	...
	<div class="middle">
		<div id="main">
			<h2 class="part-title"><?php _e('News','postechin');?></h2>
				<?php
					$additional_loop = new WP_Query("post_type=post&posts_per_page=30&paged=$paged");
					while ($additional_loop->have_posts()) : $additional_loop->the_post(); 
                        if (has_term(310, 'post_cat')) continue;
					?>
							<div class="last-post">
